...
public class StickerSize extends AbstractSticker {
    ...
    public StickerSize(Context context, FloatBuffer vertexBuf, FloatBuffer roatedTextureCoordBuf)
    {
        textTexId = new int[1];
    ...
    int check(float touchposX,float touchposY)
    {
